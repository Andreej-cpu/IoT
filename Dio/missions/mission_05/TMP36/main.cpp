...
const int tempPin = 35; // Sensore di temperatura TMP36
...
void loop() {
  ...
  // 2. Elaborazione Temperatura TMP36
  int rawADC = analogRead(tempPin);
  float voltage = (rawADC / 4095.0) * 3.3;
  float temperatureC = (voltage - 0.5) * 100.0; // Formula TMP36
  ...
  Serial.print("Temp [TMP36]: "); Serial.print(temperatureC, 1); Serial.println(" °C");
