...
In addition, you can add a `"serialMonitor"` section to [configure the Serial Monitor](guides/serial-monitor.html#configuring-the-serial-monitor "guides/serial-monitor.md#configuring-the-serial-monitor").
...
Use `wokwi-cli lint` to validate your diagram.json file and catch common issues like unknown part types, invalid pin connections, and duplicate IDs. See the [CLI Usage guide](wokwi-ci/cli-usage.html#linting-diagrams "wokwi-ci/cli-usage.md#linting-diagrams") for more details.

A partial list of part types (e.g. [wokwi-led](parts/wokwi-led.html "parts/wokwi-led.md")) can be found under the "Diagram Reference" section of this guide. We're currently working to expand this list. Meanwhile, some of the parts are also documented at [Wokwi Elements](https://elements.wokwi.com "https://elements.wokwi.com").
...
* [`wokwi-attiny85`](parts/wokwi-attiny85.html "parts/wokwi-attiny85.md") - ATtiny85
* [`wokwi-arduino-nano`](parts/wokwi-arduino-nano.html "parts/wokwi-arduino-nano.md") - Arduino Nano
* [`wokwi-arduino-mega`](parts/wokwi-arduino-mega.html "parts/wokwi-arduino-mega.md") - Arduino Mega 2560
* [`wokwi-arduino-uno`](parts/wokwi-arduino-uno.html "parts/wokwi-arduino-uno.md") - Arduino Uno R3
* [`wokwi-pi-pico`](parts/wokwi-pi-pico.html "parts/wokwi-pi-pico.md") - Raspberry Pi Pico
...
* [`board-franzininho-wifi`](parts/board-franzininho-wifi.html "parts/board-franzininho-wifi.md") - ESP32-S2
* `board-esp32-s3-devkitc-1` - ESP32-S3
* `board-esp32-p4-preview` - ESP32-P4
* [`board-st-nucleo-c031c6`](parts/board-st-nucleo-c031c6.html "parts/board-st-nucleo-c031c6.md") - STM32 Nucleo-64 with STM32C031C6 MCU
* [`board-st-nucleo-l031k6`](parts/board-st-nucleo-l031k6.html "parts/board-st-nucleo-l031k6.md") - STM32 Nucleo-32 with STM32L031K6 MCU
...
![diagram.json wire placement mini language](assets/images/diagram-format-connections-447a2925ad75aad8f5940709a16ef5b4.gif)