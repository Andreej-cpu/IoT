...
# board-bmp180 Barometric Pressure Sensor
...
The BMP180 sensor can be controlled using [Automation Scenarios](wokwi-ci/automation-scenarios.md "../wokwi-ci/automation-scenarios.md"). It exposes the following controls:
