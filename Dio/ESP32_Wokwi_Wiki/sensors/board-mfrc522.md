...
The MFRC522 communicates via SPI (Mode 0) and is commonly used with the [MFRC522 library](https://github.com/miguelbalboa/rfid "https://github.com/miguelbalboa/rfid") by Miguel Balboa or the [Arduino\_MFRC522v2 library](https://github.com/OSSLibraries/Arduino_MFRC522v2 "https://github.com/OSSLibraries/Arduino_MFRC522v2").
...
The MFRC522 reader can be controlled using [Automation Scenarios](wokwi-ci/automation-scenarios.md "../wokwi-ci/automation-scenarios.md"). It exposes the following controls:
