...
The temperature sensor can be controlled using [Automation Scenarios](wokwi-ci/automation-scenarios.md "../wokwi-ci/automation-scenarios.md"). It exposes the following controls:
