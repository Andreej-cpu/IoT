...
The information below also applies to the [slide potentiometer](wokwi-slide-potentiometer.html "wokwi-slide-potentiometer.md").
...
You can [run the example on Wokwi](https://wokwi.com/projects/298685457758159369 "https://wokwi.com/projects/298685457758159369"). Observe how the plotter graph changes as you move the potentiometer's knob.
...
The potentiometer can be controlled using [Automation Scenarios](wokwi-ci/automation-scenarios.md "../wokwi-ci/automation-scenarios.md"). It exposes the following controls:
