...
Try [this example on Wokwi](https://wokwi.com/projects/345134808605655636 "https://wokwi.com/projects/345134808605655636")

## Automation controls

The HX711 can be controlled using [Automation Scenarios](wokwi-ci/automation-scenarios.md "../wokwi-ci/automation-scenarios.md"). It exposes the following controls:
