...
| Q7 | Serial output |
| Q7\_N | Inverted serial output (usually not used) |
| DS | Serial input* |
| GND | Ground |
| VCC | Supply voltage |
...
To use the shift register, connect pins D0…D7 to your inputs (e.g. [slide switches](wokwi-slide-switch.html "wokwi-slide-switch.md") or [pushbuttons](wokwi-pushbutton.html "wokwi-pushbutton.md")). You may need to add external pull-up or pull-down [resistors](wokwi-resistor.html "wokwi-resistor.md"), especially if you go with the buttons.
...
[Run this example on Wokwi](https://wokwi.com/projects/306031380875182657 "https://wokwi.com/projects/306031380875182657").